    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('/admin/location/countries/create') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="iso_code" id="iso_code" placeholder="Enter ISO Code" maxlength="3" required>
                </div>
