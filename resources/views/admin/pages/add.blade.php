...
@section('title') Page Add @endsection
@section('content')
<div class="app-title">
   <div>
...
<div class="row">
   <div class="col-md-12">
      <div class="tile">
         <h3 class="tile-title">Add New Page</h3>
         <form method="POST" action="{{ route('admin.page.store')}}" enctype="multipart/form-data" id="saveform">
            @csrf
            <div class="row">
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-row">
                           <div class="col-md-12 mb-3">
                              ...
                              <textarea cols="80" id="description1" name="description" rows="20" class="editortextarea">{{ old('description')}}</textarea>
                           </div>
                        </div>
